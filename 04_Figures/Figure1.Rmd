...
interaction_factors <- factor(interaction(Head_Chromosome,Head_Dimorphism), 
                              levels = c("XX.G", "XX.V", "XY.V", "XY.G"))

Fig1A<-fviz_pca_ind(pca_head,
             col.ind = factor(interaction_factors,labels=c("XX-3G", "XX-VSC", "XY-VSC", "XY-3G")),
...
ggsave("../Figures/Fig1A.jpg", width = 3, height = 3)
```
Plotting Figure 1B
...
ggsave("../Figures/Fig1B.jpg", width = 3, height = 3)
```
Plotting Figure 1C
...
ggsave("../_plots/Fig1C.jpg", width = 4.5, height = 3)
```